...
\addto\captionsenglish{
    ...
    % перекрываю \refname, чтобы список литературы сам добавлял себя в
оглавление
...
%\includefigure[width=0.8\linewidth]{Условное изображение молекулы белка
(1GNA)}{biostructure}
\end{original}
...
%%\includefigure[width=\linewidth]{Модель данных UGENE
\class{BioStruct3D}}{BioStruct3D}
...
http://www.cgl.ucsf.edu/home/meng/grpmt/structalign.html
    \nocite{algolist-protopedia}    %
http://proteopedia.org/wiki/index.php/Structural\_alignment\_tools
